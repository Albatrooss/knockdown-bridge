    ...
    <section className="lobby">
      ...
      <section className="lobby">
        <div className="writing">
          ...
          <span onClick={() => copyToClipboard(`https://knockdown-bridge.netlify.app//${id.replace(/\s/g, '%20')}/lobby`)} className="link">https://knockdown-bridge.netlify.app/lasagne/lobby/{id.replace(/\s/g, '%20')}/lobby{copied && <p className="copied">Copied!</p>}</span>
        </div>
